...
CREATE TABLE IF NOT EXISTS public.inscritas2020 (
	...
	asignatura_equivalente varchar(255),
	agno int4 NOT NULL,
	semestre int4 NOT NULL,
	psp float4,
	pga float4,
	...
	mencion varchar(255),
	responsable varchar(1024),
	malla_id varchar(255),
	malla_actual int4,
	grupo_paralelo int4,
	electivo_equivalente varchar(255),
	situacion_semestre varchar(255),
	reincorporaciones int4,
	dummy varchar DEFAULT NULL,
